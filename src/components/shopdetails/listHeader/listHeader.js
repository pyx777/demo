	...
	render(){
		...
		return(
			<div className='shoplist_header'>
				...
				<div className='shoplist_header_bg' style={{backgroundImage:`url('//fuss10.elemecdn.com/${this.props.data.image_path?this.props.data.image_path:''}?imageMogr/format/webp/thumbnail/!40p/blur/50x40/')`}}></div>
				<nav>
